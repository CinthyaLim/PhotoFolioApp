...
class FavoriteAdapter(private val groupedMap: HashMap<String, List<PhotoItem>>, private val context: Context, private val rowCount : Int): RecyclerView.Adapter<FavoriteAdapter.ViewHolder>(), FavoriteInsideAdapter.OnItemClickListener  {

    private var innerAdapter: FavoriteInsideAdapter? = null
        ...
        fun bindItem(content: ItemPhoto) {
            itemBinding.apply {
                ...
                if(content.photoInside!=null){
                    val photoAdapter = FavoriteInsideAdapter(content.photoInside)
    ...
    fun setInnerAdapter(adapter: FavoriteInsideAdapter) {
